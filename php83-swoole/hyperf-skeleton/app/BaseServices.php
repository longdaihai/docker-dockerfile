...
// | HYY [ HYY赋能开发者，助力企业发展 ]
// +----------------------------------------------------------------------
// | Copyright (c) 2024 https://www.haiyunyi.cn All rights reserved.
// +----------------------------------------------------------------------
// | Licensed HYY并不是自由软件，未经许可不能去掉HYY相关版权
// +----------------------------------------------------------------------
// | Author: HYY Team <hansheng0512@163.com>
// +----------------------------------------------------------------------
...
abstract class BaseServices
{
     ...
     * @return string
     */
    protected function sys_data(string $name, int $limit = 0)
    {
